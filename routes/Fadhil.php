...
Route::get('/lost/add-lost-form', 'LostController@addLostForm')->name('addLostForm')->middleware("setLocaleLanguage");
Route::post('/lost/add-lost', 'LostController@addLost')->name('addLost')->middleware("setLocaleLanguage");
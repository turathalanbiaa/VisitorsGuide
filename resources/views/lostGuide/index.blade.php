                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <div class="aa-input-container" id="aa-input-container">
                            <input type="search" id="aa-search-input" class="aa-input-search" placeholder="Search for ..." name="search" autocomplete="off" />
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card mb-4 shadow-sm">
                    <img width="400" height="300" class="card-img-top fill" src="{{asset("storage/img/lost/". $lost->file_name)}}"    alt="Card image cap">
                        <div class="card-body">
                        <div class="card-text">

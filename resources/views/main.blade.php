...
<div class="content d-flex flex-row">
    <div class="content-right py-2">
        ...
        <div class="card rounded ml-3 mt-3">
            <div class="p-3">
                ...
                <a href="/adeua-and-zuarat" class="btn btn-secondary btn-sm rounded read-more" >{{trans("words.main_read")}}</a>
            </div>
    ...
    <div  class="col-special" style="text-align: center;margin-bottom: 50px">
                ...
                <a  href="/about_app" class="btn btn btn btn-outline-info">  {{trans("words.main_about")}}  <i class="fa fa-info"></i></a>
